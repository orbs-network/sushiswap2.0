...
test('decode hooks registration', () => {
  ...
  expect(() => decodeHooksRegistration('0x4000')).toThrow(
    'Invariant failed: Invalid hooks registration',
  )
  expect(() => decodeHooksRegistration(16384)).toThrow(
    'Invariant failed: Invalid hooks registration',
  )
  expect(() => decodeHooksRegistration(-1)).toThrow(
    'Invariant failed: Invalid hooks registration',
  )
})
