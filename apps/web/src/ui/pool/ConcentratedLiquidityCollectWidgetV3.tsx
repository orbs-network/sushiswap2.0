...
import { ConcentratedLiquidityCollectButtonV3 } from './ConcentratedLiquidityCollectButtonV3'

interface ConcentratedLiquidityCollectWidgetV3 {
...
export const ConcentratedLiquidityCollectWidgetV3: FC<
...
> = ({
  ...
  return (
    <>
      ...
      <CardFooter>
        <ConcentratedLiquidityCollectButtonV3
          position={position ?? undefined}
